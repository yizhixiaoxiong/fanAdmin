		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="rest/happuser/${msg}" name="userForm" id="userForm" method="post">
							<input hidden="hidden" name="USER_ID" id="user_id" value="${pd.USER_ID }"/>
...
<script type="text/javascript">
	...
	function hasU(){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>rest/happuser/hasU.do',
	...
	function hasE(USERNAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>rest/happuser/hasE',
	...
	function hasN(USERNAME){
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>rest/happuser/hasN',
