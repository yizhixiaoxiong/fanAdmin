...
<html lang="en">
	...
	<script type="text/javascript" src="../static/myjs/framework.js"></script>
	<link href="../static/mycss/import_basic.css" rel="stylesheet" type="text/css"/>
	<script type="text/javascript" charset="utf-8" src="../static/myjs/tab.js"></script>
	</head>
<body>
<div id="tab_menu"></div>
<div style="width:100%;">
	<div id="page" style="width:100%;height:100%;">11111111</div>
</div>		
</body>
<script type="text/javascript">

function tabAddHandler(mid,mtitle,murl){
	alert("tabAddHandler被调用")
	tab.update({
		id :mid,
		title :mtitle,
		url :murl,
